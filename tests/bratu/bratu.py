...
from common import PETSc,dx,DumbCheckpoint,inner,grad,exp,FILE_CREATE
from common import FiniteElement,FunctionSpace,Function,NonlinearVariationalProblem,NonlinearVariationalSolver,ExtrudedMesh
from common import IntervalMesh,SquareMesh,interval,quadrilateral,triangle
from common import TrialFunction,TestFunction,DirichletBC,Constant,TensorProductElement
