...
if backend == 'firedrake':
	...
	from firedrake import as_vector,grad,inner,sin,sinh,dx,pi,exp,avg,jump,ds,dS,FacetNormal,action,ds_v,ds_t,ds_b,dS_h,dS_v,HCurlElement,curl
	from firedrake import FiniteElement,TensorProductElement,SpatialCoordinate,interval,quadrilateral,triangle,HDivElement,split,div,cos,Dx,VectorElement,hexahedron
...
if backend == 'themis':
	...
	from ufl import as_vector,grad,inner,sin,sinh,dx,pi,exp,avg,jump,ds,dS,FacetNormal,action,ds_v,ds_t,ds_b,dS_h,dS_v,HCurlElement,curl
	from ufl import FiniteElement,TensorProductElement,SpatialCoordinate,interval,quadrilateral,triangle,HDivElement,split,div,cos,Dx,VectorElement,hexahedron
